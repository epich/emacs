...
;; TODO: Should we move to an undo.el file, then use cl-defstruct to
;; hold adjusted-elt and orig-undo-list? Then pending-undo-list would
;; be a list of the struct.
